 ...
 */
$messages['en'] = array(
	'wikicategorytagcloud-desc' => 'Allows to add tag clouds based on categories to a page',
);
 ...
 */
$messages['qqq'] = array(
	'wikicategorytagcloud-desc' => '{{desc|name=Wiki Category Tag Cloud|url=http://www.mediawiki.org/wiki/Extension:WikiCategoryTagCloud}}',
);
 ...
 */
$messages['ast'] = array(
	'wikicategorytagcloud-desc' => "Permite amestar a una páxina nubes d'etiquetes basaes en categoríes",
);
 ...
 */
$messages['it'] = array(
	'wikicategorytagcloud-desc' => 'Consente di aggiungere dei tag cloud in base alle categorie di una pagina',
);
